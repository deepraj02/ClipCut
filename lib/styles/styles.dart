...
class ClipCutStyles {
  ...
  static const TextStyle headlineLarge =
      TextStyle(fontSize: ClipCutStyles.largeSize);

  static const TextStyle headlineMedium =
      TextStyle(fontSize: ClipCutStyles.mediumSize);

  static const TextStyle labelLarge =
      TextStyle(fontSize: ClipCutStyles.labelLargeSize);

  static const TextStyle labelMedium =
      TextStyle(fontSize: ClipCutStyles.labelMediumSize);
